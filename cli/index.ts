...
let cli = yargs(args)
  ...
  .example("$0 mail read 190cf9f55b05efcc --format=text", "Read a message with decoded body text")
  .example("$0 mail thread 190cb53f30f3d1aa --format=text", "Read a full conversation thread")
